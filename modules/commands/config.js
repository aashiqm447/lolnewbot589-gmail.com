...
module.exports.handleReply = async function({ api, event, handleReply }) {
	...
	if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command only Aadi (Aadi Gupta)", event.threadID, event.messageID);
