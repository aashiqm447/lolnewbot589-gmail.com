...
module.exports.run = async function ({ api, event, args }) {
    const permission = [`100088009791702`,``];
	if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command. Only RISHI KUSHWAHA G", event.threadID, event.messageID);
