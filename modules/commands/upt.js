...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("𝐑𝐈𝐒𝐇𝐈 𝐊𝐔𝐒𝐇𝐖𝐀𝐇𝐀", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("𝐌𝐑๏ 𝐑𝐈𝐒𝐇𝐈" , 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("𝐌𝐑๏ 𝐑𝐈𝐒𝐇𝐈", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("𝐨𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐑𝐈𝐒𝐇𝐈" , 2000, 3600);
    ctx.beginPath();
