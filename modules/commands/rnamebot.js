...
const permission = [`100029323637418`,``];
if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command. Only ZiaRein", event.threadID, event.messageID);
